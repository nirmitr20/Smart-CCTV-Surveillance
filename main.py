...
window.iconphoto(False, tk.PhotoImage(file='C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/mn.png'))
...
#icon = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/icons/spy.png')

import os

# Correct file path using raw string
file_path = r'C:\Users\nirmi\OneDrive\Desktop\project\smart-cctv-ver2.0\icons\spy.png'
...
# Continue with your code, e.g., display the icon if available
if icon:
    # Proceed with using the icon, e.g., set it as a window icon, display it, etc.
    pass
else:
...
btn1_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/lamp.png')
...
btn2_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/rectangle-of-cutted-line-geometrical-shape.png')
btn2_image = btn2_image.resize((50,50), Image.LANCZOS)
btn2_image = ImageTk.PhotoImage(btn2_image)

btn5_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/exit.png')
btn5_image = btn5_image.resize((50,50), Image.LANCZOS)
btn5_image = ImageTk.PhotoImage(btn5_image)

btn3_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/security-camera.png')
btn3_image = btn3_image.resize((50,50), Image.LANCZOS)
btn3_image = ImageTk.PhotoImage(btn3_image)

btn6_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/incognito.png')
btn6_image = btn6_image.resize((50,50), Image.LANCZOS)
btn6_image = ImageTk.PhotoImage(btn6_image)

btn4_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/recording.png')
btn4_image = btn4_image.resize((50,50), Image.LANCZOS)
btn4_image = ImageTk.PhotoImage(btn4_image)

btn7_image = Image.open('C:/Users/nirmi/OneDrive/Desktop/project/smart-cctv-ver2.0/icons/recording.png')
